...
class Dataset_elec(Dataset):
    def __init__(self, data_set, root_path, flag='train', size=None,
                 features='MS', data_path='electricity.csv',
...
class Reduced_dataset_elec(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.data_set == 'elec':  # 4/1/1
            border1s = [0, 4*30*24*4 - self.seq_len,
                        4*30*24*4+1*30*24*4 - self.seq_len]
            border2s = [4*30*24*4, 4*30*24*4+1*30*24*4, 4*30*24*4+2*30*24*4]
        elif self.data_set == 'ECL':  # 3/1/1
            border1s = [0, 3*30*24 - self.seq_len,
                        3*30*24+1*30*24 - self.seq_len]
            border2s = [3*30*24, 3*30*24+1*30*24, 3*30*24+2*30*24]
        elif self.data_set == 'WTH':  # 3/1/1
            border1s = [0, 3*30*24*6 - self.seq_len,
                        3*30*24*6+1*30*24*6 - self.seq_len]
            border2s = [3*30*24*6, 3*30*24*6+1*30*24*6, 3*30*24*6+2*30*24*6]
        elif self.data_set == 'TRAF':  # 4/2/2
            border1s = [0, 4*30*24 - self.seq_len,
                        4*30*24+2*30*24 - self.seq_len]
            border2s = [4*30*24, 4*30*24+2*30*24, 4*30*24+4*30*24]

        elif self.data_set == 'ETTm1':  # 4/2/2
            border1s = [0, 4*30*24*4 - self.seq_len,
                        4*30*24*4+2*30*24*4 - self.seq_len]
            border2s = [4*30*24*4, 4*30*24*4+2*30*24*4, 4*30*24*4+4*30*24*4]
            ...
            border1s = [0, 4*365 - self.seq_len, 4*365+2*365 - self.seq_len]
            border2s = [4*365, 4*365+2*365, 4*365+4*365]
        border1 = border1s[self.set_type]
        border2 = border2s[self.set_type]
