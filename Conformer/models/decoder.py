...
class DecoderLayer(nn.Module):
    def __init__(self, self_attention, cross_attention, dec_lstm, step_len, d_model, c_out, d_ff=None,
        ...
        self.lstm = nn.GRU(input_size=d_model,
                           hidden_size=d_model, num_layers=dec_lstm)
        self.lstm1 = nn.GRU(input_size=d_model,
                            hidden_size=d_model, num_layers=dec_lstm)
        self.lstm2 = nn.GRU(input_size=d_model,
                            hidden_size=d_model, num_layers=dec_lstm)
    ...
    def forward(self, x, cross, x_mask=None, cross_mask=None):
        ...
        return self.norm1(x), residual_trend, hidden
